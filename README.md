...
7. Pour des tests spécifiques (avec postman par exemple), le backend répond à l'adresse: http://localhost:3000 (:warning: Attention: authentification requise pour toutes les routes /api/sauces/).